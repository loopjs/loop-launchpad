...
module.exports = function(loopGrid, inputGrabber){
  ...
  function handleInput(values, isRevert){
    if (currentSelection){
      ...
      if (offsets.length){
        ...
        releaseTransform = loopGrid.transform(move, selection, offsets)
      }
    }
  }
