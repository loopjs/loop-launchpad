...
var stateLights = require('./state_lights')


module.exports = function(self, opts){
  // opts: duplexPort, triggerOutput, scheduler
  ...
  DittyGridStream(inputStack, self.grid, opts.scheduler).pipe(opts.triggerOutput)
  ...
  // export
  controllerGrid.inputStack = inputStack
